		...
		<div class="table-data">
			<div class="order">
				<form method="POST" style="padding: 10px;">
         			<label style="padding: 10px;">Item Name</label><br>
         			<input type="text" name="name" placeholder="Enter Item Name"><br>
         			<label style="padding: 10px;">Brand</label><br>
         			...
         			<label style="padding: 10px;">Number of Use</label><br>
         			<input type="text" name="number_of_use" placeholder="Enter Number of Use"><br>
